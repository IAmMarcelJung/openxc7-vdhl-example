...
# VHDL sources — defaults to ${TOP}.vhd, override for multiple files:
# VHDL_SOURCES = top.vhd pkg.vhd util.vhd
...
${PROJECT}.json: ${VHDL_SOURCES}
	yosys -m ghdl -p "ghdl ${GHDL_OPTS} $^ -e ${TOP_MODULE} ; synth_xilinx -flatten -abc9 ${SYNTH_OPTS} -arch xc7 -top ${TOP_MODULE} ; write_json ${PROJECT}.json"
